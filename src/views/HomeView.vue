  ...
  <div class="home-root">
        ...
        >
          <div class="carousel-slide flex-shrink-0 w-full h-full relative bg-[#780000]">
            ...
            <div
              ...
              style="
                background: linear-gradient(to right, #780000 42%, #78000099 62%, transparent 80%);
              "
            ></div>
            <div
              class="carousel-content absolute inset-0 flex flex-col justify-center px-7 sm:px-12 md:px-16 py-7 sm:py-9 md:py-10 z-10"
            >
              <p class="text-[#FDF0D5]/70 text-xs font-semibold tracking-[0.2em] uppercase mb-2">
                Fashion · Thrift
              </p>
              <h2
                class="text-white text-3xl sm:text-4xl md:text-5xl leading-tight mb-4"
                style="font-family: 'CalSans', serif"
              >
                Thrifting<br />easier with us.
              </h2>
              <button @click="$router.push('/catalog')" class="cta-btn fashion-cta">
                Shop Now →
              </button>
            </div>
          </div>
          <div class="carousel-slide flex-shrink-0 w-full h-full relative bg-[#C1121F]">
            ...
            <div
              class="absolute inset-0"
              style="
                background: linear-gradient(to right, #c1121f 38%, #c1121f99 58%, transparent 76%);
              "
            ></div>
            <div
              class="carousel-content absolute inset-0 flex flex-col justify-center px-7 sm:px-12 md:px-16 py-7 sm:py-9 md:py-10 z-10"
            >
              ...
              <h2
                class="text-white text-3xl sm:text-4xl md:text-5xl leading-tight mb-2"
                style="font-family: 'CalSans', serif"
              >
                Good Fashion
              </h2>
          ...
          <div class="carousel-slide flex-shrink-0 w-full h-full relative bg-[#780000]">
            ...
            <div
              class="absolute inset-0"
              style="
                background: linear-gradient(to right, #780000 40%, #78000099 60%, transparent 78%);
              "
            ></div>
            <div
              class="carousel-content absolute inset-0 flex flex-col justify-center px-7 sm:px-12 md:px-16 py-7 sm:py-9 md:py-10 z-10"
    ...
    <section class="section-gap reveal reveal-delay-1">
      ...
      <div v-else class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 sm:gap-4">
        ...
        <p
          ...
          class="col-span-full text-center text-sm text-black/50 py-8"
        >
        ...
        >
          <div class="carousel-slide flex-shrink-0 w-full h-full relative bg-[#003049]">
            ...
            <div
              class="absolute inset-0"
              style="
                background: linear-gradient(to right, #003049 42%, #00304999 62%, transparent 80%);
              "
            ></div>
            <div
              class="carousel-content absolute inset-0 flex flex-col justify-center px-7 sm:px-12 md:px-16 py-7 sm:py-9 md:py-10 z-10"
            >
              ...
              <h2
                ...
                style="font-family: 'CalSans', serif"
              >
                Play More,<br /><span class="text-[#669BBC]">Pay Less.</span>
              </h2>
              <button @click="$router.push('/catalog?type=sports')" class="cta-btn sports-cta">
                Shop Sports →
              </button>
            </div>
          </div>
          <div class="carousel-slide flex-shrink-0 w-full h-full relative bg-[#669BBC]">
            ...
            <div
              class="absolute inset-0"
              style="
                background: linear-gradient(to right, #669bbc 40%, #669bbc99 60%, transparent 78%);
              "
            ></div>
            <div
              class="carousel-content absolute inset-0 flex flex-col justify-center px-7 sm:px-12 md:px-16 py-7 sm:py-9 md:py-10 z-10"
            >
              ...
              <button @click="$router.push('/catalog?type=sports')" class="cta-btn sports-dark-cta">
                Explore Gear →
              </button>
            </div>
          </div>
          <div class="carousel-slide flex-shrink-0 w-full h-full relative bg-[#003049]">
            ...
            >
              ...
              <p class="text-white/60 text-xs tracking-widest uppercase mb-4">
                Running · Padel · Basketball · Football
              </p>
              <button @click="$router.push('/catalog?type=sports')" class="cta-btn sports-cta">
                Explore Now →
              </button>
    ...
    <section class="section-gap reveal reveal-delay-4">
      ...
      <div v-else class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 sm:gap-4">
        ...
        />
        <p
          v-if="!sportsProducts.length"
          class="col-span-full text-center text-sm text-black/50 py-8"
        >
          Belum ada produk sports.
        </p>
      </div>
    </section>
  </div>
...
const nextFashion = () => {
  fashionIndex.value = (fashionIndex.value + 1) % 3
}
const prevFashion = () => {
  fashionIndex.value = (fashionIndex.value + 2) % 3
}
...
const nextSports = () => {
  sportsIndex.value = (sportsIndex.value + 1) % 3
}
const prevSports = () => {
  sportsIndex.value = (sportsIndex.value + 2) % 3
}
...
.section-title-wrap {
  @apply flex items-center gap-3 mb-4 sm:mb-5;
}
.section-accent {
...
/* Carousel text content offset for visual balance */
.carousel-content > p,
.carousel-content > h2,
...
.cta-btn {
  @apply w-fit px-4 sm:px-5 py-2 sm:py-2.5 text-xs sm:text-sm font-bold rounded-xl;
  border: 2px solid #111;
...
.chips-track {
  @apply flex gap-3 sm:gap-4 overflow-x-auto pb-2;
...
/* ── Loading skeleton ─────────────────────────────────────────────────────── */
.skeleton {
  @apply animate-pulse bg-black/10 rounded-xl;
}
.skeleton-card {
