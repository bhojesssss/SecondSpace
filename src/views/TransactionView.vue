    ...
    <div v-else class="tx-layout">
      ...
      <div class="tx-main">
        ...
        <section class="section-gap reveal">
          ...
          <div class="addr-card glass-panel">
            <div class="addr-head">
            ...
            <p class="addr-text">{{ address.fullAddress }}</p>
          </div>
        </section>
        ...
        <section class="section-gap reveal reveal-delay-1">
          <div class="block-title-wrap">
            <h2 class="block-title">
              Daftar Pesanan
              <span class="block-title-count">({{ totalQty }} item)</span>
            </h2>
          </div>
        ...
        <section class="section-gap reveal reveal-delay-2">
          <div class="block-title-wrap">
            <h2 class="block-title">Metode Pembayaran</h2>
          </div>
          <div class="pay-list">
            <button
              ...
              class="pay-option"
              :class="selectedPayment === method.value ? 'pay-active' : 'pay-inactive glass-panel'"
            >
        ...
        <div class="tx-summary glass-panel">
          ...
          <div class="summary-rows">
            ...
            <div class="summary-total">
              ...
              <span class="total-value">Rp {{ formatPrice(total) }}</span>
            </div>
          </div>
...
const payNow = () => {
  alert(`Pembayaran berhasil!\n\nMetode: ${paymentMethods.find(m => m.value === selectedPayment.value)?.label}\nTotal: Rp ${formatPrice(total.value)}`)
  clear()
...
.block-link {
  @apply text-xs font-bold text-[#C1121F] no-underline px-2 py-1 rounded-md;
...
.item-thumb {
  @apply w-20 h-20 sm:w-24 sm:h-24 flex-shrink-0 rounded-xl overflow-hidden;
  background: #FDF0D5;
  border: 2px solid #111;
}
.item-details {
...
.pay-option {
  @apply flex items-center gap-3 p-3 sm:p-4 rounded-xl text-left w-full;
  border: 2px solid #111;
